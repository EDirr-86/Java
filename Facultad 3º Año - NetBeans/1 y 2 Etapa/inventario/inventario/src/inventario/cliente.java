...
public void lista()
{
           try{ conexion miconexion = new conexion();
            String consprov = "select nombre_cl from cliente where estado_cl='activo'";
            ResultSet consulta =miconexion.consulta(consprov);
            do{consulta.next();
            lista.addElement(consulta.getString(1));
            this.jListCliente.setModel(lista);
...
this.jListCliente.setEnabled(false);operacion="nuevo";}
   /**
    * 
    */
...
this.jListCliente.setEnabled(true);operacion="";}
...
this.jBtnModificar.setEnabled(false);this.jBtnEliminar.setEnabled(false);operacion="";}
   ...
   {this.txtfiltro.setEnabled(false);this.txtfiltro.setText("Nombre cliente");this.jBtnModificar.setEnabled(false);this.jBtnEliminar.setEnabled(false);}   
   ...
   public cliente(javax.swing.JDialog parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        txtfiltro.setText("Nombre cliente");
        ...
        jListCliente.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jListClienteKeyPressed(evt);
            }
        });
        jScrollPane4.setViewportView(jListCliente);
        ...
        jBtnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/graficos/plus-icon.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtfiltro, javax.swing.GroupLayout.DEFAULT_SIZE, 140, Short.MAX_VALUE)
    ...
    private void jListClienteKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jListClienteKeyPressed
        if (evt.getKeyCode() == evt.VK_ENTER) {
            if (jListCliente.getSelectedIndex() == -1) {
                JOptionPane.showMessageDialog(rootPane,"No hay un nombre seleccionado");
               
            } else {
                String nombre = jListCliente.getSelectedValue().toString();
                jListCliente.requestFocus();
                }
            }
        
    }//GEN-LAST:event_jListClienteKeyPressed
...
habilitarB(); 
    ...
    private void jBtnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnModificarActionPerformed
       if(jListCliente.getSelectedValue().toString()!= null)
       {habilitarM();}
    }//GEN-LAST:event_jBtnModificarActionPerformed

    private void jBtnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnEliminarActionPerformed
int index = this.jListCliente.getSelectedIndex();
int seleccion = JOptionPane.showOptionDialog(
    this, // Componente padre
    "¿Esta seguro en eliminar a este cliente / "+jListCliente.getSelectedValue(), //Mensaje
...
if (seleccion != -1)
{
   if((seleccion + 1)==1)
   {
      try {
            conexion miconexion = new conexion();
            String cons = "update cliente set estado_cl =(?) where idcliente= "+ etidbd.getText();
...
lista();
    ...
    Object[] datos={etidbd.getText(),txtnom.getText(),txtdir.getText(),txttel.getText(),txtcuit.getText(),jTxaObs.getText()};                     
        ...
        {
        conexion miconexion = new conexion ();
        String cons = "SELECT MAX( (idcliente) +1 )FROM cliente";
    ...
    private void jBtnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnGrabarActionPerformed
       ...
       JOptionPane.showMessageDialog(null, e.getMessage());
        ...
        try {
            ...
            conexion miconexion = new conexion();
            String cons = "update cliente set nombre_cl =(?),direccion_cl =(?),telefono_cl =(?),cuit_cl =(?),idiva =(?),obser_cl =(?)"
                    + " where idcliente= '"+ etidbd.getText() + "'";
                miconexion.psPrepararSentencias = miconexion.miconexion.prepareStatement(cons);
...
{
conexion miconexion = new conexion ();
String cons = "select * from cliente where nombre_cl = '"+(String)jListCliente.getSelectedValue()+"'";
ResultSet consulta =miconexion.consulta(cons);
...
JOptionPane.showMessageDialog(null, e.getMessage());
    ...
    private void txtfiltroKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtfiltroKeyReleased
        ...
        {
            conexion miconexion = new conexion ();
            String cons = "select * from cliente where nombre_cl LIKE  '%"+this.txtfiltro.getText()+"%' and estado_cl = 'activo'";
            ResultSet consulta =miconexion.consulta(cons);
            do{consulta.next();
