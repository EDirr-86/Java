...
break;
    ...
    private void bguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bguardarActionPerformed
        ...
        validar(datos);
        /*if(chcf.isSelected()==false && che.isSelected()==false && chnr.isSelected()==false && chri.isSelected()==false && chrm.isSelected()==false)
            JOptionPane.showMessageDialog(null,"Por favor asegurece de que todos lo campos esten llenos !!");    
        else    
            {*/
