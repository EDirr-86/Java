 ...
 * @author admin
 */
public class Ejercicio35b extends javax.swing.JFrame {
 ...
 DefaultTableModel objtabla = new DefaultTableModel();
    ...
    public Ejercicio35b() {
             ...
             try 
        {
            ...
            String cons = "select id as Indice,nombre as 'Nombre del Alumno',apellido as Apellido,dni as 'D.N.I.' from alumnos";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ejercicio35b.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new Ejercicio35b().setVisible(true);
            }
        });
    }
